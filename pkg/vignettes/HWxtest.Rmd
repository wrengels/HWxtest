...
This packages uses algorithms from `r citep(me2009)` for everything.See also `r citep(list(levene1949, haldane1954, guo1992, louis1987, ward2014, rousset1995))` for good stuff `r citet(c(rousset1995, robertson1984))`.
